(function () {
    ...
    function WordSearch(wrapEl, settings) {
        ...
        this.wrapEl.addEventListener('touchmove', (event) => {
            ...
            _this.onMouseover(this.matrix[_hoveredCanvas.getAttribute('row')][_hoveredCanvas.getAttribute('col')])
        })
        ...
        var default_settings = {
            ...
            'gridSize': 10,
            'words': ['hello', 'checkers', 'minis', 'little', 'shop'],
            'wordsList': [],
            'debug': false
        }
    ...
    WordSearch.prototype.onTouchOver = function (event) {
        var _this = this;
        return function () {
